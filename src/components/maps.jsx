...
export const Maps = () => {
    return (
        ...
        >
            ...
            <div>
                <p className="text-center text-gray-500 mt-4 font-bold flex items-center justify-center gap-4 text-xl"><MdOutlineNumbers />For reservations, please call us at <span className="text-blue-600">+1 234 567 890</span></p>
                <p className="text-center text-gray-500 mt-4 font-bold flex items-center justify-center gap-4 text-xl"><i><TiLocationOutline /></i>we are located at font <span className="text-red-600">A108 Adam Street, New York, NY 535022</span> </p>
            </div>
